...
_4 spec entries folded (latest: 0004) — 21 active requirements, 8 closed._
...
- **REPO-5** — `specs/fold_spec.py` MUST be byte-identical to `spec-driven/scripts/fold_spec.py` — the skill ships the canonical copy, and this repo eats its own dogfood. _[0001 → 0004]_
